...
def registerUser(request):
	if request.method == 'POST':
		...
		if len(error) != 0:
			...
			a = User(username=username, email=email, password=hashed_password,first_name=fname)
			a.save()
			...
			# Welcome Email
			subject = "Welcome to Dan-Tech!!"
			message = "Hello " + fname + "!! \n" + "Welcome to Dan-Tech!! \nThank you for visiting our website.\nKeep scrolling and enjoy the adventure of Dan-Tech. \n\nThanking You\nMd Danish\nFounder Dan-Tech" 
